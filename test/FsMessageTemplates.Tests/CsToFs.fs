...
let createTpvFactory (destr: Destructurer) : MessageTemplates.Core.IMessageTemplatePropertyValueFactory =
    { new MessageTemplates.Core.IMessageTemplatePropertyValueFactory with
...
let fsDestrToCsDestrPolicy (destr: Destructurer) =
    { new MessageTemplates.Core.IDestructuringPolicy with
            member x.TryDestructure(value: obj, pvf: MessageTemplates.Core.IMessageTemplatePropertyValueFactory, result: byref<MessageTemplates.Structure.TemplatePropertyValue>): bool =
