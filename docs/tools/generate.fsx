...
let website = "/MessageTemplates"

let githubLink = "http://github.com/adamchester/MessageTemplates"

// Specify more information about your project
let info =
  [ "project-name", "MessageTemplates"
    "project-author", "Serilog Contributors, Adam Chester"
    "project-summary", "the ability to format named string values, and capture the properties"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/MessageTemplates" ]
